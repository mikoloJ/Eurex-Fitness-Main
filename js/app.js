    ...
    <nav class="nav wrap">
      ...
      <ul class="nav-links">
        ${links.map(l => {
          ...
          if (isJoin) return `<li class="nav-mobile-cta"><a class="nav-cta" href="${esc(l.link)}">${esc(l.text)}</a></li>`;
          return `<li><a class="${active}" href="${esc(l.link)}">${esc(l.text)}</a></li>`;
        }).join("")}
      </ul>
      <div class="nav-actions">
        <a class="nav-cta" href="join.html">Join Now</a>
        <a class="nav-whatsapp" href="${esc(SITE.brand.whatsapp)}" target="_blank" rel="noopener" aria-label="WhatsApp">
